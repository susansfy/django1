# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2018-05-14 09:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=200)),
                ('content', models.TextField()),
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signapp.Environment')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signapp.Plan')),
            ],
        ),
        migrations.CreateModel(
            name='Sign',
        ...
        migrations.AddField(
            model_name='project',
            name='sign',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signapp.Sign'),
        ),
        migrations.AddField(
            model_name='plan',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signapp.Project'),
        ),
        migrations.AddField(
